...
ALTER TABLE "trade_journal" ADD CONSTRAINT "trade_journal_account_id_kiwoom_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "public"."kiwoom_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
